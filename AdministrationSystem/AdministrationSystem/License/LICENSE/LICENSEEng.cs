...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.LICENSEEng
{
    [TestFixture]
    ...
    public class TestsLICENSEEngPage
    {
        ...
        public void LICENSEPage()
        {
            ...
            RegistrationDateEng.Clear();
            RegistrationDateEng.SendKeys("12/3/2023");
            ...
            // Report >>
            bool btnRpt = driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/main/div[2]/div/div/div[2]/button[2]")).Displayed;
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("LICENSE"));
