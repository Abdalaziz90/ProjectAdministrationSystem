...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.MarketPlanHeaderEng
{
    [TestFixture]
    ...
    public class TestsMarketPlanHeaderEngPage
    {
        ...
        public void MarketPlanHeaderPage()
        {
            ...
            String[] PlanCategoryText = { "BASIC", "ADVANCED", "Premium", "AMAZING AFILLATE" };
            ...
            Thread.Sleep(7000);
            if (TypeOfUserText[0] == "Named Users")
            {
            ...
            Thread.Sleep(7000);
            if (TypeOfUserText[2] == "Concurrent Users On The System")
            {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Market Plan Header"));
            });
