...
namespace JUSTDEVELOPMENT.Case_System.Cases.RequestlincenseLoginAr
{
    ...
    public class TestsRequestlincenseLoginAr
    {
        ...
        public void RequestlincenseLoginPage()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("طلب تسجيل الدخول للرخصة"));
            });
