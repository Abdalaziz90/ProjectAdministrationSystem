...
namespace JUSTDEVELOPMENT.Case_System.Cases.SoftwarePricingAr
{
    ...
    public class TestsSoftwarePricingAr
    {
        ...
        public void SoftwarePricingPage()
        {
            ...
            String[] CustomerText = { "البراااعة والاتقان-1", "العربية للتأمين-2", "سما عمون-3", "المكتبة الوطنية-4", "الضامنون العرب-5" };
            ...
            PricingDateEng.Clear();
            PricingDateEng.SendKeys("٣/١٢/٢٠٢٣");
            ...
            // Search Input >>
            Thread.Sleep(3000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("سما عمون" + Keys.Enter);
            Thread.Sleep(3000);
            ...
            bool btnRp = driver.FindElement(By.XPath("//button[contains(text(),'تقرير')]")).Displayed;

            string cardTitleText = driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/main/div[2]/div/div/div[1]/h4")).Text;

            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("تسعيرة البرنامج"));
