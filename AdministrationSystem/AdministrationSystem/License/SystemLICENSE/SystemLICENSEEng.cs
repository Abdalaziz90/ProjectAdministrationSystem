...
namespace JUSTDEVELOPMENT.Case_System.Cases.SystemLICENSEEng
{
    ...
    public class TestsSystemLICENSEEng
    {
        ...
        public void SystemLICENSEPage()
        {
            ...
            String[] licenseText = { "_SD", "AICC_AICC", "JNL_JNL", "A-Arab" };
            ...
            String[] codeJustDevSystemText = { "Adminitration System", "Store Managment System", "Case System", "E-Commerce", "test system12" };
            ...
            String[] codeModuleText = { "Setup-1", "User -2", "Security-9", "Setup store Managment-8", "Item Management-46", " ", "test system module-58" };
            ...
            String[] codeJustDevSystemText2 = { "Adminitration System", "Store Managment System", "Case System", "E-Commerce", "test system12" };
            ...
            String[] codeModuleText2 = { "Setup-1", "User -2", "Security-9", "Setup store Managment-8", "Item Management-46", " ", "test system module-58" };
            ...
            String[] codeJustDevSystemTextEd = { "Adminitration System", "Store Managment System", "Case System", "E-Commerce", "test system12" };
            ...
            String[] codeModuleTextEd = { "Setup-1", "User -2", "Security-9", "Setup store Managment-8", "Item Management-46", " ", "test system module-58" };
            ...
            // Search Input >>
            Thread.Sleep(3000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("Security" + Keys.Enter);
            Thread.Sleep(3000);
            ...
            bool rptBtn = driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/main/div[2]/div/div/div[2]/button[2]")).Displayed;

            string cardTitleText = driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/main/div[2]/div/div/div[1]/h4")).Text;

            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("System LICENSE"));
