...
namespace JUSTDEVELOPMENT.Case_System.Cases.MessageManagementEng
{
    ...
    public class TestsMessageManagementEng
    {
        ...
        public void MessageManagementEngPage()
        {
            ...
            String[] langText = { "jj", "English", "france", "esp", "jap", "n" };
            ...
            // Message
            driver.FindElement(By.Id("MESSAGE")).SendKeys("This Task Has Child Tasks");
            ...
            driver.FindElement(By.Id("edit")).Click();
            Thread.Sleep(3000);
            driver.FindElement(By.Id("MESSAGE")).SendKeys("Mac Address Must Not Equal CPU Info");
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            ...
            // Search Input >>
            Thread.Sleep(3000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("item price" + Keys.Enter);
            Thread.Sleep(3000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Message Managment"));
            });
