...
namespace AdministrationSystem.AdministrationSystem.Organization.BranchEng
{
    ...
    public class TestsBranchEng
    {
        ...
        public void BranchPage()
        {
            ...
            String[] ParentBranchText = { "test system 12-B_JUST_58", " " };
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Branch"));
