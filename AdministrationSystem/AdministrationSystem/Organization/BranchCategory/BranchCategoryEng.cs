...
namespace AdministrationSystem.AdministrationSystem.Organization.BranchCategoryEng
{
    ...
    public class TestsBranchCategoryEng
    {
        ...
        public void BranchCategoryPage()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Branch Category"));
