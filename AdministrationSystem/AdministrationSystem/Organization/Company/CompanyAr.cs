...
namespace AdministrationSystem.AdministrationSystem.Organization.CompanyAr
{
    ...
    public class TestsCompanyAr
    {
        ...
        public void CompanyPage()
        {
            ...
            String[] ParentCompanyText = { "123test-C_JUST_24", "TEST1-C_JUST_30", "test-1", "C_JUST_ابو محمود للبطاقات-3", " " };
            ...
            String[] SectorText = { "قطاع خاص", "قطاع حكومي", "قطاع صناعي" };
            ...
            String[] BankDefinitionText = { "بنك العربي", "بنك لبنان والمهجر", "بنك القاهرة عمان جاري" };
            ...
            String[] BankBranchText = { "بنك العربي", "بنك لبنان والمهجر", "بنك القاهرة عمان جاري" };
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("الشركة"));
