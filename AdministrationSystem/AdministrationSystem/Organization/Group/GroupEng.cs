...
namespace AdministrationSystem.AdministrationSystem.Organization.GroupEng
{

    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("Group Page")]
    [AllureFeature("Organization Page")]
    [AllureEpic("Administration System features")]
    public class TestsGroupEng
    {
        ...
        public void GroupPage()
        {
            ...
            // Group >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[4]/li/ul[1]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[4]/li/ul[1]/li/a")).Click();
            ...
            driver.FindElement(By.Id("ACTUALCOMPANIESNUM")).SendKeys("10");
            driver.FindElement(By.Id("ACTUALBRANCHESNUM")).SendKeys("20");
            driver.FindElement(By.Id("ACTUALGALLERIESNUM")).SendKeys("15");
            driver.FindElement(By.Id("ACTUALUSERSNUM")).SendKeys("13");
            driver.FindElement(By.Id("NOOFTRAN")).SendKeys("24");
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Group"));
            });
