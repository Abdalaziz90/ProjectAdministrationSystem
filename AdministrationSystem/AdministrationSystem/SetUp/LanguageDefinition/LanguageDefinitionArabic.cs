...
namespace AdministrationSystem.AdministrationSystem.SetUp.LanguageDefinitionArabic
{
    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("Language Definition Page")]
    [AllureFeature("Language Definition Page")]
    [AllureEpic("Administration System features")]
    public class TestsLanguageDefinitionArabicPage
    {
        ...
        public void LanguageDefinitionPage()
        {
            ...
            // Language Definition >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[1]/li/ul[3]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[1]/li/ul[3]/li/a")).Click();
            ...
            Thread.Sleep(5000);
            driver.FindElement(By.Id("code")).SendKeys("فحص 1");
            driver.FindElement(By.Id("name")).SendKeys("اليابانية");
            driver.FindElement(By.Id("DIRECTION")).SendKeys("LToR");
            Thread.Sleep(5000);
            driver.FindElement(By.Id("displayOrder")).SendKeys($"{int.Parse("٤٥")}");
            //wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//div[@class='e-checkbox-wrapper e-wrapper']")));
            //Thread.Sleep(3000);
            //driver.FindElement(By.XPath("//div[@class='e-checkbox-wrapper e-wrapper']")).Click();
            ...
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("name")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("NAMEJUDGMENT")).Clear();
            driver.FindElement(By.Id("NAMEJUDGMENT")).SendKeys("العربية");
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("displayOrder")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("displayOrder")).Clear();
            driver.FindElement(By.Id("displayOrder")).SendKeys($"{int.Parse("٥٠")}");
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.Id("displayOrder")).Clear();
            driver.FindElement(By.Id("displayOrder")).SendKeys("٣٠");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[contains(text(),'تعديل')]")).Click();
            Thread.Sleep(5000);
            ...
            // Search Input >>
            Thread.Sleep(5000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("أحمد جاد" + Keys.Enter);
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("تعريف لغة"));
