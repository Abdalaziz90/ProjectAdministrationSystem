...
namespace AdministrationSystem.AdministrationSystem.SetUp.LanguageDefinitionEng
{
    [TestFixture]
    ...
    public class TestsLanguageDefinitionEngPage
    {
        ...
        public void LanguageDefinitionPage()
        {
            ...
            driver.FindElement(By.Id("name")).SendKeys("Japanese");
            driver.FindElement(By.Id("DIRECTION")).SendKeys("RToL");
            Thread.Sleep(5000);
            driver.FindElement(By.Id("displayOrder")).SendKeys($"{int.Parse("45")}");
            ...
            driver.FindElement(By.Id("name")).SendKeys("english");
            ...
            driver.FindElement(By.Id("displayOrder")).SendKeys($"{int.Parse("50")}");
            Thread.Sleep(5000);
            Thread.Sleep(5000);
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.Id("displayOrder")).Clear();
            driver.FindElement(By.Id("displayOrder")).SendKeys("30");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Language Definition"));
