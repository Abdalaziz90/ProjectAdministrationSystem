...
namespace AdministrationSystem.AdministrationSystem.SetUp.LocalizationArabic
{
    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("Localization Page")]
    [AllureFeature("Localization Page")]
    [AllureEpic("Administration System features")]
    public class TestsLocalizationArabic
    {
        ...
        public void LocalizationPage()
        {
            ...
            // Localiztion >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[1]/li/ul[4]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[1]/li/ul[4]/li/a")).Click();
            ...
            Thread.Sleep(3000);
            IWebElement Language = driver.FindElement(By.XPath("//span[@role='combobox']"));
            Language.Click();
            string[] LanguageText = { "jj", "ENG", "احمد جاد", "n", "عربي", "انجليزي", "eps", "jap", "france", "tt", "English", "اليابانية" };
            if (LanguageText.Length > 0)
            {
                Random rand = new Random();
                int number = rand.Next(0, LanguageText.Length);
                Language.SendKeys(LanguageText[number] + Keys.Enter);
                Console.WriteLine(LanguageText[number]);
            }
            driver.FindElement(By.Id("RESOURSENAME")).SendKeys("اسم مصدر الترجمة");
            driver.FindElement(By.Id("RESOURCEVALUE")).SendKeys("50");
            ...
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("RESOURCEVALUE")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("RESOURCEVALUE")).Clear();
            driver.FindElement(By.Id("RESOURCEVALUE")).SendKeys("70");
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.Id("RESOURCEVALUE")).Clear();
            driver.FindElement(By.Id("RESOURCEVALUE")).SendKeys("90");
            driver.FindElement(By.XPath("//button[contains(text(),'تعديل')]")).Click();
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("ترجمة الصفحات"));
