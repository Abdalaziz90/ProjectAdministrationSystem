...
namespace AdministrationSystem.AdministrationSystem.SetUp.LocalizationEng
{
    [TestFixture]
    ...
    public class TestsLocalizationEng
    {
        ...
        public void LocalizationPage()
        {
            ...
            driver.FindElement(By.Id("RESOURSENAME")).SendKeys("Localization Resource Name");
            ...
            driver.FindElement(By.Id("RESOURCEVALUE")).SendKeys("40");
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Localization"));
