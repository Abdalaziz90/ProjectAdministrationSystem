...
namespace AdministrationSystem.AdministrationSystem.SetUp.ReminderEng
{
    [TestFixture]
    ...
    public class TestsReminderEngPage
    {
        ...
        public void ReminderPage()
        {
            ...
            driver.FindElement(By.Id("SMSMSG")).SendKeys("msg");
            driver.FindElement(By.Id("EMAILSUBJECT")).SendKeys("email Sub");
            driver.FindElement(By.Id("EMAILMESSAGE")).SendKeys("Email msg");
            ...
            driver.FindElement(By.Id("EMAILMESSAGE")).SendKeys("email");
            Thread.Sleep(5000);
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.Id("EMAILMESSAGE")).Clear();
            driver.FindElement(By.Id("EMAILMESSAGE")).SendKeys("msgs");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Reminder"));
