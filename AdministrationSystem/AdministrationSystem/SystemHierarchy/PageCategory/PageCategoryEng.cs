...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.PageCategoryEng
{
    [TestFixture]
    ...
    public class TestsPageCategoryEngPage
    {
        ...
        public void PageCategoeyPage()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Page Category"));
            });
