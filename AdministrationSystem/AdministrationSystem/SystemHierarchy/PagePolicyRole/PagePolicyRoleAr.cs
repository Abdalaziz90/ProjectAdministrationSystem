...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.PagePolicyRoleAr
{
    [TestFixture]
    ...
    public class TestsPagePolicyRoleArPage
    {
        ...
        public void PagePolicyRolePage()
        {
            ...
            String[] CATEGORYOFPAGEText = { "عدد الأدوات", "عدد الشاشات", "عدد الشاشات ذات العلاقة" };
            ...
            // Search Input >>
            Thread.Sleep(5000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("الشاشات" + Keys.Enter);
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("دور سياسة الصفحة"));
            });
