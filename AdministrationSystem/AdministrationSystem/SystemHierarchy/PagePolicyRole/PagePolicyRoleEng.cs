...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.PagePolicyRoleEng
{
    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("Page Policy Role Page")]
    [AllureFeature("System Hieracrchy Page")]
    [AllureEpic("Administration System features")]
    public class TestsPagePolicyRoleEngPage
    {
        ...
        public void PagePolicyRolePage()
        {
            ...
            // Page Policy Role >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[2]/li/ul[7]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[1]/ul[2]/li/ul[7]/li/a")).Click();
            ...
            String[] CATEGORYOFPAGEText = { "Number Of Control", "Number Of Backend", "number Of Related" };
            ...
            if (CATEGORYOFPAGEText.Length > 0)
            {
                ...
                CATEGORY.SendKeys(CATEGORYOFPAGEText[randNumber] + Keys.Enter);
            }

            driver.FindElement(By.Id("MINVALUE")).SendKeys("20");
            driver.FindElement(By.Id("MAXVALUE")).SendKeys("50");
            driver.FindElement(By.Id("WEIGHT")).SendKeys("10");
            driver.FindElement(By.Id("TOTALWEIGHT")).SendKeys("35");
            ...
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("WEIGHT")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("WEIGHT")).Clear();
            driver.FindElement(By.Id("WEIGHT")).SendKeys("25");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("edit")).Click();
            Thread.Sleep(3000);
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("MINVALUE")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("MINVALUE")).Clear();
            driver.FindElement(By.Id("MINVALUE")).SendKeys("20");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            ...
            // Search Input >>
            Thread.Sleep(5000);
            driver.FindElement(By.Id("Grid_ToolbarSearchBox")).SendKeys("Backend" + Keys.Enter);
            Thread.Sleep(5000);
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("Page Policy Role"));
            });
