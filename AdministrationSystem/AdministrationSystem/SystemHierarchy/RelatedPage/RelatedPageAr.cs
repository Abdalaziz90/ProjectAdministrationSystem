...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.RelatedPageAr
{
    [TestFixture]
    ...
    public class TestsRelatedPageArPage
    {
        ...
        public void RelatedpaePage()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("شاشات ذات علاقة"));
            });
