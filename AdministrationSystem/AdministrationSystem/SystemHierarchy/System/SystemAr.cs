...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.SystemAr
{
    [TestFixture]
    ...
    public class TestsSystemArPage
    {
        ...
        public void SystemPage()
        {
            ...
            // Image URL >>
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"dialog-440df3cb-f413-443f-a1fd-3ebc376e11b5_dialog-content\"]/form/div/div/div[21]/div/div/button")).Click();
            ...
            Assert.Multiple(() =>
            {
                Assert.That(cardTitleText, Is.EqualTo("نظام"));
            });
