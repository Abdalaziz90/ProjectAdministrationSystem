...
namespace AdministrationSystem.AdministrationSystem.SystemHierarchy.SystemErrorEng
{
    [TestFixture]
    ...
    public class TestsSystemErrorEngPage
    {
        ...
        public void SystemErrorPage()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(cardTitleText, Is.EqualTo("System Error"));
            });
